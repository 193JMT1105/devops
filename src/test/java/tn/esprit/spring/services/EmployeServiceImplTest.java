...
public class EmployeServiceImplTest {
	...
	public void testAjouterEmploye() {
		Employe employe = new Employe(1, "kacem", "yedes", "kacem@gmail.com");
	...
	public void testajouterContrat() {
		Contrat contrat = new Contrat(1, new Date(), "CVP", 500);
	...
	public void testgetEmployePrenomById() {
		Employe employe1 = new Employe(1, "kacem", "yedes", "kacem@gmail.com");
	...
	public void testdeleteEmployeById() {
		Employe employe1 = new Employe("kacem", "yedes", "kacem@gmail.com");
	...
	public void testmettreAjourEmailByEmployeId() {
		Employe employe = new Employe(4, "kacem", "yedes", "yedes@gmail.com");
		Employe emp = empRepo.save(employe);
		emp.setEmail("yedess@gmail.com");
...
//
//		Employe employe = new Employe("said", "feki", "said@esprit.com");
...
//
//		Entreprise entrepriseBDD = entRepository.findEntrepriseByName("LEP");
...
//	}
	...
	public void testMettreAjourEmailByEmployeIdJPQL() {
		Employe employe = new Employe("said", "feki", "said@esprit.com");
		int id_emp = iemployeservice.ajouterEmploye(employe);
		String newMail = "said.feki1@esprit.tn";
...
//		Employe employe1 = new Employe("Faiez", "abid", "faiez@esprit.com");
//		int id_emp = iemployeservice.ajouterEmploye(employe1);
...
//			dep.setEmployes(emps);
//		} else {
//			dep.getEmployes().add(empRepo.findById(id_emp).get());
//		}
//		deptRepoistory.save(dep);
//
//		Contrat contrat1 = new Contrat(new Date(), "CIVP", 1700);
//		contrat1.setEmploye(employe1);
//		contratRepoistory.save(contrat1);
//
//		Departement dep1 = deptRepoistory.findDepartmentByName("recherche");
...
//
//		Mission comparedMission = missionRepository.findMissionByName("Recrutement");
//
